...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [DEFAULT] = LAYOUT_hot(
        ...
        MO(LOWER),   TMUX_PREFIX, KC_NUBS, LCTL_T(KC_Z),    KC_X,    KC_C,   LALT_T(KC_V),     KC_B,    QK_REPEAT_KEY,    KC_N,    KC_M,   KC_COMM, KC_DOT, LCTL_T(KC_SLSH), KC_UP,   MO(COMMANDS), 
    ...
    [BASIC] = LAYOUT_hot(
        ...
        KC_LCTL, MO(LOWER),                  KC_LGUI, KC_SPC,   MO(RAISE),  KC_LEFT_ALT,                                    KC_LEFT, KC_DOWN, KC_RIGHT
    ),
